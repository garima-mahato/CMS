<?php
	...
	if($_SESSION['userid']!="")
	{
		...
		$col["name"] = "n_exam_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
		...
		$col["editoptions"] = array("value"=>'1:BTech;2:MTech');
		$cols[] = $col;
		...
		$col = array();
		$col["title"] = "Result Declared";
		$col["name"] = "c_res_declared";
		$col["width"] = "25";
		$col["editable"] = true; // this column is not editable
		$col["align"] = "center"; // this column is not editable
		$col["search"] = true; // this column is not searchable
		...
		$grid["sortname"] = 'n_exam_id'; // by default sort grid by this field
...
$g->select_command = "SELECT *  FROM t_cms_exam";
