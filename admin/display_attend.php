...
$g->select_command = "SELECT e.id,e.n_att_id,e.c_std_id,e.c_course_id,s.c_course_name  FROM t_cms_stud_attend as e inner join t_cms_courses as s on e.c_course_id=s.c_course_id";

// this db table will be used for add,edit,delete
$g->table = "t_cms_stud_attend";
