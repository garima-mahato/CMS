...
<center>
  <div style="background-color:#FFFFFF;width:850px;font-family:copperplate gothic light">
      <ul>
                <li><a href="upload_stud_info.php">Student Info</a></li>
				<li><a href="upload_timetable.php">Exam Time Table</a></li>
				<li><a href="upload_result.php">Exam Result</a></li>
				<li><a href="upload_att.php">Attendance</a></li>
				<li><a href="upload_blacklist.php">Blacklist </a></li>
      </ul>
  </div>
</center>
