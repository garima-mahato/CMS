<?php
	...
	if($_SESSION['userid']!="")
	{
		...
		$col["name"] = "n_att_id"; // grid column name, must be exactly same as returned column-name from sql (tablefield or field-alias) 
		$col["width"] = "18";
...
$g->select_command = "SELECT * FROM t_cms_attend";

// this db table will be used for add,edit,delete
$g->table = "t_cms_attend";
