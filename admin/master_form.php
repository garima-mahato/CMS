...
<center>
  <div style="background-color:#FFFFFF;width:850px;font-family:copperplate gothic light">
      <ul>
                <li><a href="deg_manage.php">Degree</a></li>
				<li><a href="course_manage.php">Courses</a></li>
				<li><a href="student_manage.php">Student</a></li>
				<li><a href="exam_manage.php">Exam</a></li>
				<li><a href="result_manage.php">Result</a></li>
				<li><a href="attendance.php">Attendance</a></li>
				<li><a href="staff_manage.php">Faculty</a></li>
      </ul>
  </div>
</center>
